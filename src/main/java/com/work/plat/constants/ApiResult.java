...
public class ApiResult<T> implements Serializable {
    ...
    private ApiResult(IResultCode resultCode) {
        this(resultCode, null, MessageUtils.get(resultCode) );
    }
    ...
    private ApiResult(IResultCode resultCode, T data) {
        this(resultCode, data, MessageUtils.get(resultCode.getMessage()) );
    }
    ...
    public static <T> ApiResult<T> data(T data) {
        return data(data, MessageUtils.get(MessageUtils.get("success")));
    }
    ...
    public static <T> ApiResult<T> data(Integer code, T data, String msg) {
        return new ApiResult<>(code, data, data == null ? MessageUtils.get("null") : msg);
    }
    ...
    public static <T> ApiResult<T> status(boolean flag) {
        return flag ? success(MessageUtils.get("success")) : fail(MessageUtils.get("fail"));
    }
